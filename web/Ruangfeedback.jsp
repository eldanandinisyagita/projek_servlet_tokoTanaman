<%-- 
    Document   : Ruangfeedback
    Created on : Jan 30, 2022, 7:25:16 PM
    Author     : HP
--%>
...
<body>
  <div class="sidebar">
    ...
    <a class="active" href="Ruangfeedback.jsp">Ruang Feedback</a>
  </div>
  
  <div class="content">
      <div class="topnav">
          <h2 style=" display: inline-block; color: black; text-align: left; font-size: 25px; font-family: 'PT Sans', sans-serif; margin-top: 20px">Data Feedback</h2>
      </div>
      <br>
      <table width="1080px" style="" class="table-content">
          <tr>
              <th colspan="6" style="height: 70px; background-color: #ebebeb">
          ...
          <tr style="text-align: left; font-weight: bold">
                <td width="100px">Kode Feedback</td>
                <td width="100px">Id Customer </td>
                <td width="100px">Tanggal Posting </td>
                <td width="170px">Isi Feedback</td>
                <td width="80px" style="text-align: center;"> Aksi </td>
           </tr>
           <% while (rs.next()){%>
           <tr>
               <td> <%=rs.getString("kode_feedback")%> </td>
               <td> <%=rs.getString("id_customer")%> </td>
               <td> <%=rs.getString("tanggal_posting")%> </td>
               <td> <%=rs.getString("isi_feedback")%> </td>
               <td>&emsp;&emsp;&emsp;
                   <a href="delete_feedback.jsp?kode_feedback=<%=rs.getString("kode_feedback")%>" class="btn btn-danger"> delete</a>               
               </td>
